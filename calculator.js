...
function checkKey(e) {
    e = e || window.event;
		switch (e.code) {
				case "Enter": //enter bar = select
						clickSelectedItem();
						document.getElementById("select").style.backgroundColor = "#f48b84";
						document.getElementById("left").style.backgroundColor = "#92e599";
						document.getElementById("down").style.backgroundColor = "#92e599";
						document.getElementById("right").style.backgroundColor = "#92e599";
						document.getElementById("up").style.backgroundColor = "#92e599";
						break;
				case "Space": //space bar = select
						clickSelectedItem();
						document.getElementById("select").style.backgroundColor = "#f48b84";
						document.getElementById("left").style.backgroundColor = "#92e599";
						document.getElementById("down").style.backgroundColor = "#92e599";
        ...
        case "ArrowLeft": // left arrow = previous
            selectPrevious();
						document.getElementById("select").style.backgroundColor = "#f24a3e";
						document.getElementById("left").style.backgroundColor = "#c8f7ca";
						document.getElementById("down").style.backgroundColor = "#92e599";
						document.getElementById("right").style.backgroundColor = "#92e599";
						document.getElementById("up").style.backgroundColor = "#92e599";
            break;
        case "ArrowUp": // up arrow
            selectUp();
						document.getElementById("select").style.backgroundColor = "#f24a3e";
						document.getElementById("up").style.backgroundColor = "#c8f7ca";
						document.getElementById("down").style.backgroundColor = "#92e599";
						document.getElementById("left").style.backgroundColor = "#92e599";
						document.getElementById("right").style.backgroundColor = "#92e599";
            break;
        case "ArrowRight": // right arrow = next
						selectNext();
						document.getElementById("select").style.backgroundColor = "#f24a3e";
						document.getElementById("right").style.backgroundColor = "#c8f7ca";
						document.getElementById("down").style.backgroundColor = "#92e599";
						document.getElementById("left").style.backgroundColor = "#92e599";
						document.getElementById("up").style.backgroundColor = "#92e599";
            break;
        case "ArrowDown": //down arrow
            selectDown();
						document.getElementById("select").style.backgroundColor = "#f24a3e";
						document.getElementById("down").style.backgroundColor = "#c8f7ca";
						document.getElementById("right").style.backgroundColor = "#92e599";
						document.getElementById("left").style.backgroundColor = "#92e599";
						document.getElementById("up").style.backgroundColor = "#92e599";
            break;
